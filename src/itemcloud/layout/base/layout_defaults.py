...
LAYOUT_MAXIMIZE_TYPE = 'layout_maximize_type'
LAYOUT_MAXIMIZE_TYPE_HELP = '|'.join(RESIZE_TYPES)
...
LAYOUT_HEADERS = [
    ...
    LAYOUT_RESIZE_TYPE,
    LAYOUT_MAXIMIZE_TYPE,
    LAYOUT_SCALE,
    LAYOUT_MARGIN,
    LAYOUT_OPACITY,
    LAYOUT_RESIZE_RESAMPLING,
    LAYOUT_ROTATE_RESAMPLING,
    LAYOUT_NAME,
...
LAYOUT_HEADERS_HELP = [
    ...
    LAYOUT_MAXIMIZE_TYPE_HELP,
    LAYOUT_SCALE_HELP,
    LAYOUT_MARGIN_HELP,
    LAYOUT_OPACITY_HELP,
    LAYOUT_RESIZE_RESAMPLING_HELP,
    LAYOUT_ROTATE_RESAMPLING_HELP,
    LAYOUT_NAME_HELP,
