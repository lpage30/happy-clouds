...
cdef SearchProperties restart_search(SearchProperties last_properties) noexcept nogil:
    cdef SearchProperties result = start_search(last_properties.area, last_properties.pattern)
    result.loop = last_properties.loop
    return result

cdef SearchProperties next_linear_search(Box last_found, SearchProperties last_properties) noexcept nogil:
...
cdef SearchProperties next_ray_search(Box last_found, SearchProperties last_properties) noexcept nogil:
    # search patterns: https://i.ytimg.com/vi/8rXv-0gg-ZY/maxresdefault.jpg
...
cdef SearchProperties next_spiral_search(Box last_found, SearchProperties last_properties) noexcept nogil:
    # search patterns: https://i.ytimg.com/vi/8rXv-0gg-ZY/maxresdefault.jpg
...
cdef SearchProperties start_search(Box area, SearchPattern pattern) noexcept nogil:
    cdef SearchProperties result
...
def native_search(boxes: Box[::1], properties: SearchProperties): # return native_box
    return search(boxes, properties)

def native_next_search(
    last_found: Box,
    last_properties: SearchProperties
): # return native_search_properties
